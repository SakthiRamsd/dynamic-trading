    ...
    <>
      <div className="two-container">
        ...
        <div className="two-right">
          ...
          <p>
            <b>Fundamental Research</b> Lorem Ipsum has been industry's standard
            dummy text since the 1500s.
          </p>
          <p>
            <b>Trading Ideas & Reports</b> Lorem Ipsum has been industry's
            standard dummy text since the 1500s.
          </p>
          <p>
            <b>Knowledge center</b> Lorem Ipsum has been industry's standard
            dummy text since the 1500s.
          </p>
        </div>
      </div>
