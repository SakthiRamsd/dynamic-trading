      ...
      <footer className="footer-section">
        <div className="footer-links">
          ...
          <div className="footer-column">
            ...
            <ul>
              <li>
                <a href="#phone">Phone: +91 123456789</a>
              </li>
              <li>
                <a href="#email">Email - dummyemail@gmail.com</a>
              </li>
              <li>
                <a href="#address">Address - 467 Cottage St. Alex, VA 22304</a>
              </li>
            </ul>
          </div>
        </div>
